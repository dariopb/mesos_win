...
if (WIN32)
  set(STOUT_TEST_DEPENDENCIES ${STOUT_TEST_DEPENDENCIES} ${CURL_TARGET} ${ZLIB_TARGET})
endif (WIN32)
...
if (WIN32)
  set(STOUT_TEST_INCLUDE_DIRS ${STOUT_TEST_INCLUDE_DIRS} ${CURL_INCLUDE_DIR} ${ZLIB_INCLUDE_DIR})
endif (WIN32)
...
if (WIN32)
  set(STOUT_TEST_LIB_DIRS ${STOUT_TEST_LIB_DIRS} ${CURL_LIB_DIR} ${ZLIB_LIB_DIR})
endif (WIN32)
...
if (WIN32)
  set(STOUT_TEST_LIBS ${STOUT_TEST_LIBS} ${CURL_LFLAG} ${ZLIB_LFLAG})
else (WIN32)
  set(STOUT_TEST_LIBS
    ${STOUT_TEST_LIBS}
    ${GTEST_LFLAG}
